			...
			<tr>
    			...
    			<td>
					<select class="select-medium" size="1" id="dropcp_style" name="dropcp_style">
						<option value="hc_dropcape_square" selected="selected">Sqaure Content</option>
						<option value="hc_dropcape_circle">Sqaure Circle</option>
						<option value="hc_dropcape_simple">Simple/Default</option>
					</select>
				</td>
    		</tr>
			<tr>
