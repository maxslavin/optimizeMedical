		...
		<tbody>
			<tr><td class="lable-all">Alert Type</td>
    			<td><select class="select-medium" size="1" id="alert_style" name="alert_style">
					<option value="hc_alert_warning" selected="selected">Warning</option>
					<option value="hc_alert_error">Error</option>
					<option value="hc_alert_success">Success</option>
					<option value="hc_alert_info">Info</option>
					</select>
				</td>
    		</tr>				
