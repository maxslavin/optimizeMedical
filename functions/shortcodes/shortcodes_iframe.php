...
<head>
<title><?php _e("Insert Shortcode",'health');?></title>
...
<div id="wpex-shortcodes-popup">
	...
	<h2 id="shortcode-selector-title"><?php _e("Shortcode Selector",'health');?></h2>
		...
		<form action="/" method="get" accept-charset="utf-8">
			<div>
				<select name="shortcode-select" id="shortcode-select" size="1">
               		<option value="default" selected="selected"><?php _e("Shortcodes",'health');?></option>  
					 <option value="accordion"><?php _e("Accordion",'health');?></option>	
                	<option value="alert"><?php _e("Alert",'health');?></option>
               		<option value="button"><?php _e("Button",'health');?></option>
                    <option value="tabs"><?php _e("Tabs",'health');?></option>
					<option value="drop"><?php _e("Drop-Caps",'health');?></option>
					<option value="gridsystemlayout"><?php _e("Grid System Layout",'health');?></option>
					<option value="tooltip"><?php _e("Tool Tip",'health');?></option>
					<option value="heading"><?php _e("Heading",'health');?></option>					
				</select>
			</div>
		</form>
        </div>
