    		...
    		<tr>
    			...
    			<td>
					<select class="select-medium" size="1" id="buttonstyle" name="buttonstyle">
                      	<option selected="selected" value="hc_btn_blue">Blue</option>
						<option value="hc_btn_green">Green</option>
						<option value="hc_btn_white">White</option>
					    <option value="hc_btn_black">Black</option>
						<option value="hc_btn_red">Red</option>
						<option value="hc_btn_orange">Orange</option>
                        <option value="hc_btn_pink">Pink</option>
						<option value="hc_btn_purple">Purple</option>
						<option value="hc_btn_golden">Golden</option>
			...
			<tr>
    			...
    			<td>
					<select class="select-medium" size="1" id="size" name="size">
            			...
            			<option selected="selected" value="hc_btn_large">Large</option>
						<option value="hc_btn_small">Small</option>
            			<option value="hc_btn_mini">Mini</option>
        			</select>				
				</td>
    		</tr>
			<tr>
