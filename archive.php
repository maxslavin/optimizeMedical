...
* 	@license      :	license.txt
* 	@filesource   :	wp-content/themes/health-center/arcive.php
*/
get_header();?>
...
<div class="container">
	<div class="row">
		<div class="hc_page_header_area">
			<h1><?php if ( is_day() ) : ?>
					<?php  _e( "Daily Archives:", 'health' ); echo (get_the_date()); ?>
						<?php elseif ( is_month() ) : ?>
						<?php  _e( "Monthly Archives:", 'health' ); echo (get_the_date( 'F Y' )); ?>
						<?php elseif ( is_year() ) : ?>
						<?php  _e( "Yearly Archives:", 'health' );  echo (get_the_date( 'Y' )); ?>
						<?php else : ?>
						<?php _e( "Blog Archives", 'health' ); ?>
						<?php endif; ?>
			</h1>
		</div>
	</div>
